                    ...
                    <div className="global-container slider-height flex justify-start items-center text-white gap-4">
                        <div className="w-11/12 sm:w-full max-w-4xl space-y-4">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link href='/events' className="btn bg-tprimary btn-lg gap-2 text-white">
                                ...
                                bg-black/40 border-tprimary text-tprimary hover:bg-black-20 hover:border-emerald-500  gap-2">
